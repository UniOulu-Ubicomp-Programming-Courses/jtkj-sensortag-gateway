...
function readDataToString(data) {
  ...
  //console.log(Buffer.from("id:" + addr + ","), data);
  //return Buffer.concat([Buffer.from("id:" + addr + ","), data.slice(2)]);
  return "id:" + addr + "," + data.slice(2).toString('binary');
}
